...
지은도 연구실에 있어요. 지은은 책상에서 코드를 봐요. 민수와 하나의 이야기를 들어요.

민수가 컴퓨터를 열어요: "자, 먼저 ROOT를 열 거예요. 데이터를 읽을 거예요."

민수가 키보드를 쳐요. 화면에 코드가 나와요.

"이제 하나가 해 봐. 천천히 해."

하나가 키보드 앞에 앉아요. 천천히 쳐요. 에러가 나와요.
...
민수가 말해요: "응, 다음 주에 파이썬도 가르쳐 줄게. 먼저 ROOT를 잘 배워야 해."
